...
def main():
    parser = argparse.ArgumentParser(description="Train a PCPO agent in Isaac Lab (standalone entry).")
    ...
    from config.galileo_pcpo_cfg import ALGO_CFG, DEFAULT_TRAIN_CFG
