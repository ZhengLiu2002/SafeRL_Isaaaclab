...
def main():
    parser = argparse.ArgumentParser(description="Train a FOCPO agent in Isaac Lab (standalone entry).")
    ...
    from config.galileo_focpo_cfg import ALGO_CFG, DEFAULT_TRAIN_CFG
    ...
    for it in range(max_iterations):
        ...
        if it % log_interval == 0:
            ...
            if writer:
                ...
                writer.add_scalar("Loss/learning_rate", algo_params.get("learning_rate", 1e-3), total_steps)
